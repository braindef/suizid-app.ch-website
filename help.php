		...
		<!-- Nav -->
			<nav id="nav">
				<ul class="container">
					...
					<li><a href="index.php#work">Mithelfen</a></li>
					<li><a href="index.php#portfolio">Andere Organisationen</a></li>
...
<p style="color: red;font-size: 1em;">bitte nach dem Chat bewertung abgeben und mit dem Beenden Knopf beenden</p>
  ...
  <fieldset style="font-size:1.5em;margin:auto;font-weight: bold;">
    <input type="radio" id="gerettet" name="Punkte" value="gerettet"><label for="gerettet"><font color="green">Hat mich gerettet :))</font></label><br>
    <input type="radio" id="geholfen" name="Punkte" value="geholfen"><label for="geholfen"><font color="orange">Hat mir ein bisschen geholfen :)</font></label><br>
    <input type="radio" id="verschlimmert" name="Punkte" value="verschlimmert"><label for="verschlimmert"><font color="red">Hat es verschlimmert :(</font></label> <br>
    <input type='button' id="logout" value="beenden" style="font-size:0.5em;left=50%" >
  </fieldset>
